                            ...
                            <div className="flex-1">
                              <div className="flex items-center mb-2">
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mr-3 ${
                                  suggestion.type === 'trainer_change' ? 'bg-blue-100 text-blue-800' :
                                  suggestion.type === 'timing_change' ? 'bg-yellow-100 text-yellow-800' :
                                  suggestion.type === 'level_change' ? 'bg-purple-100 text-purple-800' :
                                  suggestion.type === 'remove_class' ? 'bg-red-100 text-red-800' :
                                  'bg-green-100 text-green-800'
                                }`}>
                                  {suggestion.type === 'trainer_change' ? 'Trainer Change' :
                                   suggestion.type === 'timing_change' ? 'Timing Change' :
                                   suggestion.type === 'level_change' ? 'Level Change' :
                                   suggestion.type === 'remove_class' ? 'Remove Class' :
                                   'Add Class'}
                                </span>
